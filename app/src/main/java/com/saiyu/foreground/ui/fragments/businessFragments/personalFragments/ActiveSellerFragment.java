...
@EFragment(R.layout.fragment_active_seller)
public class ActiveSellerFragment extends BaseFragment implements CallbackUtils.ResponseCallback,CallbackUtils.OnActivityCallBack{
    @ViewById
    ...
    public static ActiveSellerFragment newInstance(Bundle bundle) {
        ActiveSellerFragment_ fragment = new ActiveSellerFragment_();
    ...
    @AfterViews
    void afterView() {
        tv_title_content.setText("Q币寄售(卖家)服务协议");
    }
    ...
    public void setOnResponseCallback(String method, BaseRet baseRet) {
        ...
        if(method.equals("ActiveSellerFragment_activeSeller")){
                    ...
                    if(status == 0){
                        ...
                        DialogUtils.showDialog(getActivity(), "提示", "激活卖家需要补填信息，是否补填信息", "取消", "补填信息", new OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                intent.putExtras(bundle);
                                mContext.startActivityForResult(intent,ContainerActivity.ActiveSellerFragmentTag);
                            }
                        });
                    } else if(status == 1){
                        ApiRequest.activeSeller("ActiveSellerFragment_activeSeller",pb_loading);
                    }
