...
public class SellerWebUrlAdapter extends RecyclerView.Adapter<SellerWebUrlAdapter.MyHolder> {
    List<QBListRet.DatasBean.ItemsBean> mItems;
    private OnItemClickListener mOnItemClickListener;
    public void setOnItemClickListener(OnItemClickListener onItemClickListener) {
        this.mOnItemClickListener = onItemClickListener;
    }

    public SellerWebUrlAdapter(List<QBListRet.DatasBean.ItemsBean> list){
        this.mItems = list;
    }

    @NonNull
    @Override
    public SellerWebUrlAdapter.MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_base_record, viewGroup, false);
        return new SellerWebUrlAdapter.MyHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SellerWebUrlAdapter.MyHolder myHolder, final int i) {
    ...
    public void refreshData(List<QBListRet.DatasBean.ItemsBean> list) {
        if (list != null) {
            mItems.clear();
            mItems.addAll(list);
