...
public class RechargeOrderHistoryAdapter extends RecyclerView.Adapter<RechargeOrderHistoryAdapter.MyHolder> {
    List<OrderReceiveHistoryRet.DatasBean.ItemsBean> mItems;
    private OnItemClickListener mOnItemClickListener;
    public void setOnItemClickListener(OnItemClickListener onItemClickListener) {
        this.mOnItemClickListener = onItemClickListener;
    }

    public RechargeOrderHistoryAdapter(List<OrderReceiveHistoryRet.DatasBean.ItemsBean> list){
        this.mItems = list;
    }

    @NonNull
    @Override
    public RechargeOrderHistoryAdapter.MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_base_record, viewGroup, false);
        return new RechargeOrderHistoryAdapter.MyHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RechargeOrderHistoryAdapter.MyHolder myHolder, final int i) {
    ...
    public void refreshData(List<OrderReceiveHistoryRet.DatasBean.ItemsBean> list) {
        if (list != null) {
            mItems.clear();
            mItems.addAll(list);
