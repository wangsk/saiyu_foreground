...
public class SellerOrderManagerAdapter extends RecyclerView.Adapter<SellerOrderManagerAdapter.MyHolder> {
    List<SellerOrderManagerRet.DatasBean.ItemsBean> mItems;
    private OnItemClickListener mOnItemClickListener;
    public void setOnItemClickListener(OnItemClickListener onItemClickListener) {
        this.mOnItemClickListener = onItemClickListener;
    }

    public SellerOrderManagerAdapter(List<SellerOrderManagerRet.DatasBean.ItemsBean> list){
        this.mItems = list;
    }

    @NonNull
    @Override
    public SellerOrderManagerAdapter.MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_base_record, viewGroup, false);
        return new SellerOrderManagerAdapter.MyHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SellerOrderManagerAdapter.MyHolder myHolder, final int i) {
    ...
    public void refreshData(List<SellerOrderManagerRet.DatasBean.ItemsBean> list) {
        if (list != null) {
            mItems.clear();
            mItems.addAll(list);
